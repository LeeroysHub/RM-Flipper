rm -rf LH*-*-*.tgz LH*-*-*.zip .sconsign.dblite dist build build/f7-firmware-C/resources/apps build/f7-firmware-C/resources/nfc/LHProTrainedAmiibo
git pull
DATE_VAR=`date +%m%d`
TIME_VAR=`date +%H%M`
...
# ./fbt updater_package
# mv dist/f7-C/f7-update-LH420FAP "LH$DATE_VAR-$TIME_VAR"
...
tar -cf "../../../LH$DATE_VAR-$TIME_VAR/resources.tar" *
cd ../../../
zip -rq "LH$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.zip" "LH$DATE_VAR-$TIME_VAR"
tar -czf "LH$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.tgz" "LH$DATE_VAR-$TIME_VAR"
